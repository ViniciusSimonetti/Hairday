...
try {
    //limpa os periodos para evitar duplicidade
    periodMorning.innerHTML = "";
    periodAfternoon.innerHTML = "";
    periodNight.innerHTML = "";
    
    //Rendeza os agendamentos por periodo 
    dailySchedules.forEach(schedule => {    

        //Criar os elementos para exibir o agendamento
        const item = document.createElement("li");
        const time = document.createElement("strong");
        const name = document.createElement("span");

        //adicionar o ID do agendamento para facilitar a identificação
    ...
    console.log("ERRO LOCALIZADO", error.message);
